...
purpleAirUrl = "https://www.purpleair.com/json?show=10586"
purple_air_info = get_purple_air(purpleAirUrl)
...
if len(purple_air_info) != 0:
    ...
    writer.writerow(["mapVersion", "baseVersion", "mapVersionString", "results.0.ID", "results.0.ParentID",
                     ...
                     "results.0.A_H", "results.0.temp_f", "results.0.humidity", "results.0.pressure", "results.0.AGE",
                     "results.0.Stats.v", "results.0.Stats.v1", "results.0.Stats.v2", "results.0.Stats.v3",
                     ...
                     "results.1.THINGSPEAK_SECONDARY_ID", "results.1.THINGSPEAK_SECONDARY_ID_READ_KEY", "results.1.Lat",
                     "results.1.Lon", "results.1.PM2_5Value", "results.1.LastSeen", "results.1.State", "results.1.Type",
                     "results.1.Hidden", "results.1.Flag",	"results.1.DEVICE_BRIGHTNESS",
                     ...
                     "results.1.A_H", "results.1.temp_f", "results.1.humidity", "results.1.pressure", "results.1.AGE",
                     "results.1.Stats.v", "results.1.Stats.v1", "results.1.Stats.v2", "results.1.Stats.v3",
...
# if there's data in the response, write CSV rows
if purple_air_info and stats_0 and stats_1 is not None:
    ...
    writer.writerow([purple_air_info["mapVersion"], purple_air_info["baseVersion"], purple_air_info["mapVersionString"],
                     ...
                     purple_air_info["results"][0]["AGE"], stats_0[0], stats_0[1], stats_0[2], stats_0[3], stats_0[4], stats_0[5], stats_0[6], stats_0[7],
                     stats_0[8], stats_0[9],
